...
class FlightOperationSchemaContractTests(unittest.TestCase):
    ...
    def test_execution_route_constraints_and_active_route_contract_exist(self):
        ...
        self.assertIn("route_geometry geometry(geometry, 4326)", self.sql)
        self.assertIn("flight_operation_execution_route_route_geometry_srid_chk", self.sql)
        self.assertIn("st_srid(route_geometry) = 4326", self.sql)
