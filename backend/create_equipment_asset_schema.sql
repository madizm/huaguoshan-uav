...
comment on view api.equipment_online_statistics is '按设备类别统计设备总数、在线设备数和在线率的只读资源。';
...
comment on column api.equipment_online_statistics.online_count is '该类别连接状态为 online 的设备数量。';
comment on column api.equipment_online_statistics.online_rate is '该类别设备在线率，百分比范围 0 到 100，保留两位小数。';
...
grant select on api.equipment_online_statistics to admin;
